...
{
    public partial class ReportePresencia : Form
    {
        public ReportePresencia()
        {
            InitializeComponent();
        }
        ConsultasSQL sql = new ConsultasSQL();

        private void ReportePresencia_Load(object sender, EventArgs e)
        {
            dataGridView1.DataSource = sql.ReportePresencia();
        }
        ...
        private void buscar_btn_Click(object sender, EventArgs e)
        {
            ...
            dataGridView1.DataSource = sql.ObtenerReporteJornadaIncompletaBuscar(fechas);
        }
    }
}
